...
def tExport(processedTrace, ratName):
    abfWriter.writeABF1(sweepData= processedTrace, filename= os.path.join(os.getcwd(), "Processed Data", "%s Rat %s Processed Data.abf"%(datetime.today().strftime('%Y-%m-%d'), ratName)), units="V", sampleRateHz= 3333.33)

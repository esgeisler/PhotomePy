...
class TracePeaks(top.TotalPeaks):
    def __init__(self, processedSignalArray, mainFile, traceIndex):
        ...
        self.totArea = 0
        self.riseRate = np.zeros(self.mostPeaksInTrace)
        self.decayRate = np.zeros(self.mostPeaksInTrace)
    ...
    #TODO Edit such that this function will work when used to iterate over a single peak.
    ...
    def decaySet(self):
        decayTauList = np.zeros_like(self.mostPeaksInTrace)
